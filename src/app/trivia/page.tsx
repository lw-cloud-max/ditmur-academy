...
export default function TriviaPage() {
  ...
  const [timeLeft, setTimeLeft] = useState(60); // 60 seconds for 10 questions
      ...
      <div className="space-y-6 max-w-4xl mx-auto pb-32 animation-fade-in">
        ...
        {!quizStarted && !quizFinished && (
          <div className="bg-white p-12 rounded-3xl border border-slate-200 shadow-sm text-center">
            ...
            <p className="text-slate-500 mb-8 max-w-md mx-auto">You have 60 seconds to answer 10 random questions. Get a perfect score to unlock today's badge.</p>
