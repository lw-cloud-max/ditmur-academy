...
export default function MobileNav() {
  ...
  // Menu content
  const menuContent = (
    <div className="md:hidden" style={{ position: 'fixed', inset: 0, zIndex: 999999 }}>
      {/* Backdrop */}
      <div 
      ...
      {/* Menu Panel */}
      <div 
        className="absolute inset-y-0 left-0 w-80 max-w-[85vw] bg-gradient-to-b from-[#0A192F] to-[#001744] shadow-2xl transform transition-transform duration-300 ease-in-out"
  ...
  return (
    <>
      ...
      {/* Render menu in a portal to escape overflow-hidden */}
